...
public class ThreadSafeDeferredCallback1 {

    public static void main( String args[] ) throws InterruptedException {
        DeferredCallbackExecutor1.runLateThenEarlyCallback();
    }
}

class DeferredCallbackExecutor1 {
    ...
    public static void runLateThenEarlyCallback() throws InterruptedException {
        final DeferredCallbackExecutor1 deferredCallbackExecutor = new DeferredCallbackExecutor1();
        ...
        Thread lateThread = new Thread(new Runnable() {
            public void run() {
                CallBack cb = new CallBack(800, "Hello this is the callback submitted first");
        ...
        Thread earlyThread = new Thread(new Runnable() {
            public void run() {
                CallBack cb = new CallBack(100, "Hello this is callback sumbitted second");
                deferredCallbackExecutor.registerCallback(cb);
            }
        });
        earlyThread.start();
