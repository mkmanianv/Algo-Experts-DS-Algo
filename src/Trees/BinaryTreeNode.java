...
public class BinaryTreeNode {
	...
	// Sets the data in this Trees.BinaryTreeNode node.
	...
	// Returns a String representation of this Trees.BinaryTreeNode.
	...
	// Computes a hash code for the complete binary tree rooted at this Trees.BinaryTreeNode node.
	public int hashCode() {
	...
	// Returns a new Trees.BinaryTreeNode equal to (but not the same as) this binary tree.
	// Every node in this new Trees.BinaryTreeNode will be created by the copy method; values
	...
	// of its original structure. No new Trees.BinaryTreeNode nodes are created in this
	// process.
